  ...
  return (
    <div className="font-sans mx-20 my-20">
      ...
      <p className=" text-2xl mb-6">
        Restorative is a platform dedicated to helping you manage and understand
        your chronic pain through alternative treatments. We believe in the power of data and insights to
        transform the way you approach pain relief.
      </p>
      <p className=" text-2xl mb-6">
      ...
      <p className=" text-2xl mb-6">
        Whether you're exploring mindfulness, physical therapy or other holistic approaches,
